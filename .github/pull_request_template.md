...
Describe the user-visible outcome and why the change belongs in this skill.

## Safety and compatibility

- [ ] Permission and trust boundaries are preserved.
- [ ] Platform-specific behavior is capability-checked rather than assumed.
...
<!-- Include commands, results, and any platform routes not tested. -->
