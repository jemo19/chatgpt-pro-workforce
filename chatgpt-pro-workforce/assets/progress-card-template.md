...
Pro gate: {{EXPECTED_ACCOUNT_MATCH_AND_PRO_MAX_POWER_VERIFIED_AT_OR_BLOCKED_REVERIFY_REQUIRED_OR_NOT_APPLICABLE}}
...
- ChatGPT Pro gate: entitlement `{{CAPABILITY_STATE}}`; expected account
  `{{MATCH|MISMATCH|UNKNOWN|NOT_APPLICABLE}}`; target conversation
